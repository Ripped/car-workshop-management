...
class ReportFinanceScreen extends StatefulWidget {
  const ReportFinanceScreen({super.key});

  @override
  State<ReportFinanceScreen> createState() => _ReportFinanceScreenState();
}

class _ReportFinanceScreenState extends State<ReportFinanceScreen> {
  final _formKey = GlobalKey<FormBuilderState>();

  late ExpensesProvider expensesProvider;
  ReportExpensesTotal? reportResult;
  bool isLoading = true;
  ...
  Future getIzvjestaj() async {
    try {
      reportResult = await expensesProvider.getFinanceReport(search!);
                ...
                children: [
                  ...
                  pw.Text(
                      datumOd != null && datumOd != null
                          ...
                          : 'Pregled izvjestaja za sva utrosena sredstva',
                      textAlign: pw.TextAlign.center),
                            ...
                            fontWeight: pw.FontWeight.bold,
                              ...
                              for (var item in reportResult!.reportExpenses!)
                                pw.Container(
                                  margin: const pw.EdgeInsets.only(left: 70.0),
                                  padding:
                                      const pw.EdgeInsets.only(bottom: 3.0),
                                  child: pw.Row(
                                    mainAxisAlignment:
  ...
  void initState() {
    super.initState();
    expensesProvider = context.read<ExpensesProvider>();
    search = ReportWorkOrderSearch();
    search?.dateFrom = DateTime(2020, 5, 5, 0, 0, 0, 0, 0).toIso8601String();
    search?.dateTo = DateTime(2030, 5, 5, 0, 0, 0, 0, 0).toIso8601String();
    getIzvjestaj();
  }
        ...
        child: isDataLoaded
            ? ListView(
                ...
                children: [
                  ...
                  buildInfoCard(
                    title: "Pregled utrosenih sredstava",
                    items: [],
                  ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (reportResult!.reportExpenses!.isEmpty)
                Container(
                ...
                SingleChildScrollView(
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      /*ReportExpensesTotal reportExpenses =
                          reportResult[index];*/
                      return Column(
                        ...
                        children: [
                          /*Text(
                            DateFormat('MMMM d y')
                                .format(reportExpenses.total.toString()),
