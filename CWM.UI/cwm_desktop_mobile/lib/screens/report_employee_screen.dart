...
class ReportEmployeeScreen extends StatefulWidget {
  const ReportEmployeeScreen({super.key});

  @override
  State<ReportEmployeeScreen> createState() => _ReportEmployeeScreenState();
}
...
class _ReportEmployeeScreenState extends State<ReportEmployeeScreen> {
  ...
  Future<void> generatePDF() async {
              ...
              children: [
                ...
                pw.Text(
                    datumOd != null && datumOd != null
                        ...
                        : 'Pregled izvjestaja za sve radnike',
                    textAlign: pw.TextAlign.center),
    ...
    final path =
        '${directory?.path}/${"Izvještaj_radnika ${DateTime.now().year}_${DateTime.now().month}_${DateTime.now().day}_${DateTime.now().millisecondsSinceEpoch}.pdf"}';
