...
class _ReportOrderScreenState extends State<ReportOrderScreen> {
  ...
  Future getIzvjestaj() async {
    try {
      reportResult = await workOrderProvider.getOrderReport(search!);
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return pw.Column(
                      ...
                      children: [
                        ...
                        for (var item in workOrderInfo.workOrders)
                          pw.Container(
                            margin: const pw.EdgeInsets.only(left: 70.0),
            ...
            children: [
              ...
              if (reportResult!.workOrderInfo.isEmpty)
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'Nema izvjestaja za datume u intervalu: [ ${formatDate1(datumOd)} - ${formatDate1(datumDo)} ]',
