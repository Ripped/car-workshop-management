    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2001, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, "rs2cwm@gmail.com", "Amir", 0, null, "Sendić", "062342376", "test", "admin" },
                    { 2, new DateTime(2000, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2, "rs2cwm@gmail.com", "Samra", 1, null, "Tufo", "062342376", "test", "employee" },
                    { 3, new DateTime(1990, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 3, "rs2cwm@gmail.com", "Omer", 0, null, "Tufo", "062342376", "test", "user" },
                    { 4, new DateTime(1975, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, 4, "rs2cwm@gmail.com", "Merima", 1, null, "Kremić", "062342376", "Admin", "merima" },
                    { 5, new DateTime(2001, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, 5, "rs2cwm@gmail.com", "Damir", 0, null, "Kahvic", "062342376", "Admin", "dario" },
                    { 6, new DateTime(1994, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 6, 6, "rs2cwm@gmail.com", "Selmir", 1, null, "Babić", "062342376", "Admin", "selmir" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Akcija na servise za vozila starija od 5 god!", "Servis akcija", 1 },
                    { 2, "Akcija na servise za vozila starija od 5 god!", "Servis akcija", 1 },
                    { 3, "Akcija na servise za vozila starija od 5 god!", "Servis akcija", 1 },
                    { 4, "Akcija na servise za vozila starija od 5 god!", "Servis akcija", 1 },
                    { 5, "Akcija na servise za vozila starija od 5 god!", "Servis akcija", 1 },
                    { 6, "Akcija na servise za vozila starija od 5 god!", "Servis akcija", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Volkswagen", "WVWZZZ6NZ1Y125494", 1392, "Gasoline", 55, "Polo", new DateTime(2000, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Manual", 3 },
                    { 4, "Volkswagen", "WVWZZZ6NZ1Y125494", 1392, "Gasoline", 55, "Polo", new DateTime(2000, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Manual", 3 },
                    ...
                    { 7, "Volkswagen", "WVWZZZ6NZ1Y3125494", 1392, "Gasoline", 55, "Polo", new DateTime(2000, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Manual", 3 },
                    { 8, "Volkswagen", "WVWZZZ6NZ1Y1525494", 1392, "Gasoline", 55, "Polo", new DateTime(2000, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Manual", 3 },
                    { 9, "Volkswagen", "WVWZZZ6NZ1Y1255494", 1392, "Gasoline", 55, "Polo", new DateTime(2000, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Manual", 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pregled vozila, zamjena guma", 1, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3348), 1, "Provjera klime", 1, 1 },
                    { 2, "Pregled vozila, zamjena guma", 2, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3397), 0, "Provjera klime", 2, 2 },
                    { 3, "Pregled vozila, zamjena guma", 3, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3400), 4, "", 3, 3 },
                    { 4, "Pregled vozila, zamjena guma", 2, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3402), 5, "Provjera klime", 3, 9 },
                    { 5, "Pregled vozila, zamjena guma", 3, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3404), 1, "Provjera klime", 3, 7 },
                    { 6, "Pregled vozila, zamjena guma", 1, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3407), 0, "Provjera klime", 3, 8 }
                });

            migrationBuilder.InsertData(
                table: "WorkOrders",
                columns: new[] { "Id", "AppointmentId", "Concerne", "Description", "EmployeeId", "EndTime", "GarageBox", "OrderNumber", "Payment", "ServicePerformed", "StartTime", "Sugestions", "Total", "UserId", "VehicleId" },
                values: new object[,]
                {
                    { 1, 1, "Paljenje auta", "Potrebno duze vrijeme da upali kada je auto zagrijano", 1, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "SGTA152ASF276", false, 1, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provjeriti dizne i alnaser", 30m, 1, 1 },
                    { 2, 2, "Paljenje auta", "Potrebno duze vrijeme da upali kada je auto zagrijano", 2, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "SGTA252ASF276", false, 0, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provjeriti dizne i alnaser", 40m, 2, 2 },
                    { 3, 3, "Paljenje auta", "Potrebno duze vrijeme da upali kada je auto zagrijano", 3, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "SGTA352ASF276", false, 4, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provjeriti dizne i alnaser", 20m, 3, 3 },
                    { 4, 4, "Paljenje auta", "Potrebno duze vrijeme da upali kada je auto zagrijano", 4, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "SGTA452ASF276", false, 3, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provjeriti dizne i alnaser", 40m, 4, 4 },
                    { 5, 5, "Paljenje auta", "Potrebno duze vrijeme da upali kada je auto zagrijano", 5, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "SGTA552ASF276", false, 5, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provjeriti dizne i alnaser", 60m, 5, 5 },
                    { 6, 6, "Paljenje auta", "Potrebno duze vrijeme da upali kada je auto zagrijano", 6, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "SGTA652ASF276", false, 1, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provjeriti dizne i alnaser", 40m, 6, 6 },
                    { 7, 6, "Paljenje auta", "Potrebno duze vrijeme da upali kada je auto zagrijano", 6, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "SGTA752ASF276", false, 0, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provjeriti dizne i alnaser", 50m, 6, 6 },
                    { 8, 6, "Paljenje auta", "Potrebno duze vrijeme da upali kada je auto zagrijano", 6, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "SGTA852ASF276", false, 2, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provjeriti dizne i alnaser", 10m, 6, 6 },
                    { 9, 6, "Paljenje auta", "Potrebno duze vrijeme da upali kada je auto zagrijano", 6, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "SGTA952ASF276", false, 5, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provjeriti dizne i alnaser", 40m, 6, 6 },
                    { 10, 6, "Paljenje auta", "Potrebno duze vrijeme da upali kada je auto zagrijano", 6, new DateTime(2024, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "SGTA102ASF276", false, 1, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provjeriti dizne i alnaser", 70m, 6, 6 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3546), 1, 1 },
                    { 2, 2, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3550), 2, 2 },
                    { 3, 3, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3552), 3, 3 },
                    { 4, 4, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3554), 4, 4 },
                    { 5, 5, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3556), 5, 5 },
                    { 6, 6, new DateTime(2025, 7, 5, 11, 29, 33, 604, DateTimeKind.Local).AddTicks(3558), 6, 6 }
                });
