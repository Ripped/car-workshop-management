    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pregled vozila, zamjena guma", 1, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(535), 1, "Provjera klime", 1, 1 },
                    { 2, "Pregled vozila, zamjena guma", 2, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(589), 0, "Provjera klime", 2, 2 },
                    { 3, "Pregled vozila, zamjena guma", 3, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(592), 4, "", 3, 3 },
                    { 4, "Pregled vozila, zamjena guma", 2, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(595), 5, "Provjera klime", 3, 9 },
                    { 5, "Pregled vozila, zamjena guma", 3, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(597), 1, "Provjera klime", 3, 7 },
                    { 6, "Pregled vozila, zamjena guma", 1, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(599), 0, "Provjera klime", 3, 8 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(734), 1, 1 },
                    { 2, 2, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(739), 2, 2 },
                    { 3, 3, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(741), 3, 3 },
                    { 4, 4, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(743), 4, 4 },
                    { 5, 5, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(745), 5, 5 },
                    { 6, 6, new DateTime(2025, 7, 4, 21, 2, 58, 354, DateTimeKind.Local).AddTicks(747), 6, 6 }
                });
