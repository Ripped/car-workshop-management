...
namespace CWM.Database.Migrations
{
    ...
    [Migration("20240517131829_correction of VehicleHistory")]
    partial class correctionofVehicleHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CWM.Database.Models.WorkOrder", b =>
                {
                    ...
                    b.Property<int?>("VehicleServieHistoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VehicleServieHistoryId");
            ...
            modelBuilder.Entity("CWM.Database.Models.WorkOrder", b =>
                {
                    ...
                    b.HasOne("CWM.Database.Models.VehicleServiceHistory", "VehicleServieHistory")
                        .WithMany("WorkOrders")
                        .HasForeignKey("VehicleServieHistoryId");
                    ...
                    b.Navigation("VehicleServieHistory");
                });
